...
public class EquipamentoDTO implements Serializable{
	...
	private List<EquipamentoItem> equipamentoItem = new ArrayList<>();
	...
	public EquipamentoDTO(Equipamento entity,List<EquipamentoItem> equipamentoItem) {
		this(entity);
		this.equipamentoItem = equipamentoItem.stream().map(x -> new EquipamentoItem(x.getId(), x.getNumeroSerie(), x.getSituacao(), null)).collect(Collectors.toList());
	}
	
	
	public List<EquipamentoItem> getEquipamentoItem() {
